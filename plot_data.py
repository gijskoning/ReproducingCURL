...
def read_file(name_of_file, max_step):
    ...
    return time_steps, rewards, total_time
...
def plot_data(name_of_file=None, calculate_average_each_step=20000, average_over_last_steps=200000,
              scale_reward=1, only_average=True, show=True, color="", max_step=None):
    time_steps, rewards, time_elapsed = read_file(name_of_file, max_step)
